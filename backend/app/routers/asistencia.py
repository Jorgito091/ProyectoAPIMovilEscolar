...
@router.get("/fecha")
async def listar_asistencias_por_fecha(fecha:datetime,id_clase:int ,service: AsistenciaService = Depends(get_asistencia_service)):
    return service.obtener_alumno_dependiendo_el_dia(fecha,id_clase)
