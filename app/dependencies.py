...
def get_tarea_service(repo: TareaRepository = Depends(get_tarea_repo) , repo_user: UserRepository = Depends(get_user_repo)) -> TareaService:
    return TareaService(repo, repo_user)
